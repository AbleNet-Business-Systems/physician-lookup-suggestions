(function () {
  ...
  const stateInputId = 116269790;
  const fullNameInputId = 116269785;
  const addressOneId = 116269788;
  const cityId = 116269789;
  const phoneId = 116269787;
  const zipId = 117347956;
  const npiId = 119711514;
